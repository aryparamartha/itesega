                        ...
                        @if(count($allMessage))
                            @foreach($allMessage as $m)
                                <tr>
                                    ...
                                    <td>
                                        <center>
                                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#create-team{{$m->id}}">
                                                <i class="fas fa-reply"></i>
                                            </button>
                                            <!-- Modal -->
                                            <div class="modal fade" id="create-team{{$m->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                        ...
                                                        <form action="{{route('message.store')}}" method="POST">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <input id="email" type="text" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{$m->email}}" disabled>
                                                                ...
                                                                <input name="team_id" type="hidden" value="{{$m->user_id}}">
