                        ...
                        @if(count($adminMessage))
                            @foreach($adminMessage as $m)
                                <tr>
                                    ...
                                    <td>
                                        @if($m->adminMessage == NULL)
											<center><i style="font-size: 24px" class="text-danger fas fa-eye-slash"></i></center>
										@else
										{{-- Button Trigger Modal --}}
											<center><a href="#" data-toggle="modal" data-target="#showMessage{{$m->id}}" class="text-success"><i style="font-size: 24px" class="fas fa-eye"></i></a></center>

											<!-- Modal -->
											<div class="modal fade" id="showMessage{{$m->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
												<div class="modal-dialog modal-dialog-centered" role="document">
													<div class="modal-content">
														<div class="modal-header">
